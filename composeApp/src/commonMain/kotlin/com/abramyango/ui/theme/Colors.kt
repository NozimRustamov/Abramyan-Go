...
val LightAppColors = AppColors(
    ...
    // Glass - полупрозрачные элементы с тенью
    glassSurface = Color(0x80FFFFFF),         // 50% white
    glassBorder = Color(0x33000000),          // 20% black
    glassHighlight = Color(0xB3FFFFFF),       // 70% white
